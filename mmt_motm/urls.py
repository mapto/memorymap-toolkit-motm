...
urlpatterns = [
    ...
    path("events/heatmap/", views.LifeJourneyHeatmapView.as_view(), name="life_journey_heatmap"),
    path("events/<int:pk>/", views.EventDetailView.as_view(), name="event_detail"),
    path("events/search/", views.event_search, name="event_search"),
    path("locations/", views.LocationListView.as_view(), name="location_list"),
    path("locations/taxonomy/", views.LocationTaxonomyView.as_view(), name="location_taxonomy"),
